...
<svelte:head>
  ...
  <meta
    name="description"
    content="What Lean Six Sigma is, and why a flaky test is literally 'variation' in Six Sigma terms — worth root-causing rather than just re-running until it goes green."
  />
</svelte:head>
