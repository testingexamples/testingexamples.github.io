...
<svelte:head>
  ...
  <meta
    name="description"
    content="Free open source HTML fixtures for practicing browser automation: find elements by id, name, class, link text, and XPath, and interact with form inputs."
  />
</svelte:head>
